...
public class StepDetector implements SensorEventListener {
    ...
    public StepDetector(Context context, StepChangeListener stepChangeListener) {
        mContext = context;
...
//                updateStepCounter();
                Log.e("zy", "count == 9 : " + mCount);
//                stepChangeListener.stepCreate(mCount);
                getStep(mCount);
            } else {
                this.mCount++;
//                PreferencesHelper.setCurrentStep(mContext, mCount);
...
//                stepChangeListener.stepCreate(mCount);
    ...
    private void getStep(long counterStep) {
//        lastCount
//        if(lastStep == 0) {
//            stepChangeListener.stepCreate(0);
//        }else{
        stepChangeListener.stepCreate(counterStep - lastCount);
        lastCount = counterStep;
//        }
    }
