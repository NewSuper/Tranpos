...
public class MultipleQueryProduct extends Product implements Cloneable{
    ...
    private String batchPrice = "0";
    private String batchPrice2 = "0";
    private String batchPrice3 = "0";
    private String batchPrice4 = "0";
    private String batchPrice5 = "0";
    private String batchPrice6 = "0";
    private String batchPrice7 = "0";
    private String batchPrice8 = "0";
    private String minPrice = "0";
    private String otherPrice = "0";
    private String postPrice = "0";
    private String purPrice = "0";
    private String salePrice = "0";
    private String vipPrice = "0";
    private String vipPrice2 = "0";
    private String vipPrice3 = "0";
    private String vipPrice4 = "0";
    private String vipPrice5 = "0";
