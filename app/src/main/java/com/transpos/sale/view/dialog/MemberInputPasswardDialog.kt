...
import com.transpos.sale.view.HandInputKeyboardView
...
class MemberInputPasswardDialog : FixDialogFragment(),
    ...
    override fun onStart() {
        super.onStart()
        if (mBuilder == null) {
            mBuilder = MemberInputPasswardDialog.Builder()
        }
    ...
    class Builder{
       ...
       var gravity = Gravity.CENTER
        ...
        fun setWithParams(withParams: Int): MemberInputPasswardDialog.Builder {
            this.withParams = withParams
            return this
        }

        fun setGravity(gravity: Int): MemberInputPasswardDialog.Builder {
            this.gravity = gravity
            return this
        }

        fun setAnimations(animations: Int): MemberInputPasswardDialog.Builder {
            this.animations = animations
            return this
        }

        fun setHeightParams(heightParams: Int): MemberInputPasswardDialog.Builder {
