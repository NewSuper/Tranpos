...
public class DiscountDialog extends FixDialogFragment implements SixteenKeyboardView.OnKeyboardInputListener {
    ...
    private DiscountDialog setmBuilder(Builder mBuilder) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_discount, container, false);
    ...
    private void initView() {
        ...
        tv_dialog_title.setText("整单折扣");
        //KeyboardUtils.disableShowInput(tv_input);
    }
