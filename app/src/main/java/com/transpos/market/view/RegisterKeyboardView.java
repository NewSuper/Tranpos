...
public class RegisterKeyboardView extends FrameLayout {
    ...
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.register_login_keyboard_view, this, true);
    ...
    @OnClick({R.id.tv_num_0,R.id.tv_num_1,R.id.tv_num_2,R.id.tv_num_3,
            R.id.tv_num_4,R.id.tv_num_5,R.id.tv_num_6,R.id.tv_num_7,R.id.tv_num_8,R.id.tv_num_9,
            R.id.tv_delete,R.id.tv_confirm})
