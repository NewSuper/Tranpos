package com.newsuper.t.juejinbao.ui.upnp.util;
...
public class UpnpUtil {
    ...
    public static UDN uniqueSystemIdentifier(String salt) {
        ...
        if (null != Application.getHostName()
                && null != Application.getHostAddress()) {
            systemSalt.append(Application.getHostName()).append(
                    Application.getHostAddress());
        }
