...
public class MovieCartonHotActivity extends BaseActivity<BasePresenter, ActivityMoviecartonhotBinding>{
    ...
    public int getLayoutId() {
        return R.layout.activity_moviecartonhot;
    }
    ...
    public void initView() {
        ...
        pageAdapter = new MovieCartonHotPageAdapter(getSupportFragmentManager(), tags);
...
//        mPresenter.getMovieNewPlaylist(mActivity);
    ...
    public static void intentMe(Context context){
        Intent intent = new Intent(context , MovieCartonHotActivity.class);
