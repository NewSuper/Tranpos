...
import com.newsuper.t.databinding.ViewPlayerpopupBinding;
 ...
 * 播放器弹窗
 */
public class PlayerPopupWindow2 {
    ...
    public PlayerPopupWindow2(Activity activity, JzvdPlayerBusiness jzvdStd, TPListener tpListener) {
