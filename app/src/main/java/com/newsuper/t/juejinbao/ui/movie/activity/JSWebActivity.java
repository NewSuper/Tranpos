...
public class JSWebActivity extends BaseActivity<PublicPresenterImpl, ActivityJswebBinding> {
    ...
    private void init() {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            ...
            public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
                Toast.makeText(JSWebActivity.this, message, Toast.LENGTH_LONG).show();
                Log.e("zy" , "hxb: " + message);
                result.cancel();
//                operate(message);
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                Log.e("zy", "onProgressChanged = " + newProgress);
                if (newProgress >= 100) {
    ...
    public void initData() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                getVideoJs = download("http://192.168.1.75:8848/live/js/getJkkVideo.js");
...
//                        JSWebActivity.this.runOnUiThread(new Runnable() {
//                            @Override
//                            public void run() {
