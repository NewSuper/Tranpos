...
public class TaskEarnPopupWindow extends PopupWindow {
    ...
    public TaskEarnPopupWindow(Context context, String msg) {
        super(context);
        mContext = context;
...
//        setTouchable(true);
        ...
        mContentView = View.inflate(mContext, R.layout.task_earn, null);
