...
public class MovieShowHotAdapter extends RecyclerView.Adapter<MovieShowHotAdapter.MyViewHolder>{
    private Context context;
    private List<MovieShowHotEntity.DataBeanX.DataBean> items = new ArrayList<>();


    public MovieShowHotAdapter(Context context){
        this.context = context;
    }


    public void update(List<MovieShowHotEntity.DataBeanX.DataBean> items){
        this.items = items;
    ...
    class ItemView extends MyViewHolder implements View.OnClickListener {
        private MovieShowHotEntity.DataBeanX.DataBean dataBean;
        ...
        public ItemView(ViewGroup parent) {
            super((ViewGroup) LayoutInflater.from(context).inflate(R.layout.item_movie_tvhot, parent, false));
        ...
        public void setData(Object object , int position) {
            ...
            dataBean = (MovieShowHotEntity.DataBeanX.DataBean) object;
