package com.newsuper.t.juejinbao.ui.share.presenter;
...
public class ShareFragmentPresenter extends ShareBasePresenter {
...
//        }
     ...
     * @param type       分享到哪里
     */
    public void throughSdkShareWXFriends(final Activity context,
                                         final String shareTiele,
        ...
        Observable.just(ShareUtils.shareWXReadyRx(shareImage))
                ...
                .map(new Func1<String[], Bitmap>() {
                    ...
                    public Bitmap call(String[] strings) {
                        ...
                        if (ShareStringUtils.isEmpty(shareImage)){
                            return  BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_share_def);
                        }
