...
public class AnimUtil {
    public static void animHeightToView(final View v, final int start, final int end, final boolean isToShow, final long duration) {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (!isToShow) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            animHeightToView(v, v.getLayoutParams().height, 0, false, duration);
                        }
                    },1000);
