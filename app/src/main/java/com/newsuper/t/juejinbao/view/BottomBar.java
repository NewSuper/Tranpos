...
//        mTabLayout.setBackgroundColor(Color.WHITE);
    ...
    public BottomBar insertItem(final BottomBarTab tab, int position) {
        ...
        mTabLayout.addView(tab, position);
        mTabs.add(position, tab);
        changeAfterTabPosition(position);
        return this;
    }
    ...
    private void changeAfterTabPosition(int insertPos){
    ...
    public void setCurrentItem(final int position) {
        mTabLayout.post(new Runnable() {
            ...
            public void run() {
                try {
                    if(mTabLayout.getChildAt(position)!=null){
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (mCurrentPosition != ss.position) {
            if(mTabLayout.getChildAt(mCurrentPosition)!=null){
                mTabLayout.getChildAt(mCurrentPosition).setSelected(false);
            }
            if(mTabLayout.getChildAt(ss.position)!=null){
