...
public class MovieShownSoonAdapter extends RecyclerView.Adapter<MovieShownSoonAdapter.MyViewHolder>{
    private Context context;
    private List<MovieNewTabRankEntity.DataBeanX.DataBean> items = new ArrayList<>();


    public MovieShownSoonAdapter(Context context){
    ...
    class ItemView extends MyViewHolder implements View.OnClickListener {
        ...
        public ItemView(ViewGroup parent) {
            super((ViewGroup) LayoutInflater.from(context).inflate(R.layout.item_movie_shownsoon, parent, false));
...
//            MovieSearchActivity.intentMe(context , beanMovieSearchItem.getTitle() , beanMovieSearchItem);
            ...
            MyToast.show(context , "该电影还未上映，等上映后再来搜一下吧");
        }
