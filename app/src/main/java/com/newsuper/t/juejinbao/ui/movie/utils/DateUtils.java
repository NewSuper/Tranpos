...
public class DateUtils {
     ...
     * @return
     */
    public static String showYearAndMon(long seconds) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM");
        String date = sdf.format(seconds * 1000L);
        return date;
    }
     ...
     * @return
     */
    public static String showDay(long seconds) {
     ...
     * @return
     */
    public static String showYearAndMonAndDay(long seconds) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String date = sdf.format(seconds * 1000L);
        return date;
    }
