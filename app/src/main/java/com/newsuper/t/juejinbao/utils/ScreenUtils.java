...
public class ScreenUtils {
    ...
    public static int getScreenHeight() {
        return JJBApplication.getContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static float dpToPx(float dp) {
        return dp * JJBApplication.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / JJBApplication.getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / JJBApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * JJBApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = JJBApplication.getContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
    ...
    public static int getScreenBrightnessInt255() {
        ...
        try {
            screenBrightness = Settings.System.getInt(JJBApplication.getContext().getContentResolver(), Settings.System.SCREEN_BRIGHTNESS);
        } catch (Exception e) {
            e.printStackTrace();
        }
