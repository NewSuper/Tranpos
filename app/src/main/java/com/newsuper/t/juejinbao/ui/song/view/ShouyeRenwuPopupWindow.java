...
public class ShouyeRenwuPopupWindow {
    private Context context;
    final PopupWindow popupWindow2;

    private Handler handler = new Handler();

    public ShouyeRenwuPopupWindow(Context context){
        this.context = context;
        View view = LayoutInflater.from(context).inflate(R.layout.popup_shouyerenwu, null);
...
//        //在控件上方显示    向上移动y轴是负数
//        int width = Utils.getScreenWidth(context) / 10 * 7 - popupWindow2.getContentView().getMeasuredWidth() / 2;
