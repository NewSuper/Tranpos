...
public class NetworkUtils {
    ...
    public static void setMobileDataEnabled(final boolean enabled,Context Context) {
        try {
            TelephonyManager tm =
                    (TelephonyManager) Context.getSystemService(android.content.Context.TELEPHONY_SERVICE);
            if (tm == null) return;
    ...
    public static boolean getWifiEnabled(Context Context) {
        ...
        WifiManager manager = (WifiManager)Context.getSystemService(android.content.Context.WIFI_SERVICE);
