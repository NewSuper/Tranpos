...
public class MovieTVHotAdapter extends RecyclerView.Adapter<MovieTVHotAdapter.MyViewHolder>{
    private Context context;
    private List<MovieTVHotEntity.DataBeanX.DataBean> items = new ArrayList<>();


    public MovieTVHotAdapter(Context context){
        this.context = context;
    }


    public void update(List<MovieTVHotEntity.DataBeanX.DataBean> items){
        this.items = items;
    ...
    class ItemView extends MyViewHolder implements View.OnClickListener {
        private MovieTVHotEntity.DataBeanX.DataBean dataBean;
        ...
        public void setData(Object object , int position) {
            ...
            dataBean = (MovieTVHotEntity.DataBeanX.DataBean) object;
