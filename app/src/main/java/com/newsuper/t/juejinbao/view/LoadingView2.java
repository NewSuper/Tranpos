...
public class LoadingView2 extends FrameLayout {
    ...
    public LoadingView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            int loadingView = a.getResourceId(R.styleable.LoadingLayout_loadingView, R.layout.moviedetail_loading_view);
    ...
    protected void onFinishInflate() {
        ...
        Glide.with(this).load(R.drawable.moviedetail_loading).into((ImageView)mLoadingView.findViewById(R.id.progress));
...
//                refreshingAnim.start();
    ...
    public LoadingView2 setOnEmptyClickListener(OnClickListener onEmptyClickListener) {
        this.onEmptyClickListener = onEmptyClickListener;
        return this;
    }

    public LoadingView2 setOnErrorClickListener(OnClickListener onErrorClickListener) {
        this.onErrorClickListener = onErrorClickListener;
        return this;
    }

    public LoadingView2 setEmptyView(@LayoutRes int layout) {
    ...
    public LoadingView2 setErrorView(@LayoutRes int layout) {
    ...
    public LoadingView2 setLoadingView(@LayoutRes int layout) {
    ...
    public LoadingView2 setEmptyText(String text) {
        ((TextView) findViewById(R.id.tv_msg)).setText(text);
        return this;
    }

    public LoadingView2 setErrorText(String text) {
