...
import com.newsuper.t.juejinbao.ui.book.entity.BookChapterEntity.Chapter;

import java.util.List;

public class NoAimWidget extends OverlappedWidget {

    public NoAimWidget(Context context, String bookId, List<Chapter> chaptersList, OnReadStateChangeListener listener) {
