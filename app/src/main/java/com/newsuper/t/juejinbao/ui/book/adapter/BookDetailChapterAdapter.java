...
public class BookDetailChapterAdapter extends RecyclerView.Adapter<MyViewHolder>{

    private Context context;
    private List<BookChapterEntity.Chapter> items = new ArrayList<>();
    private OnItemClickListener onItemClickListener;

    public BookDetailChapterAdapter(Context context, OnItemClickListener onItemClickListener) {
    ...
    public class ItemViewHolder extends MyViewHolder implements View.OnClickListener {
        ...
        ItemViewHolder(ViewGroup parent) {
            super((ViewGroup) LayoutInflater.from(context).inflate(R.layout.item_book_chapter_detail, parent, false));
