...
public class RewardADPopupWindow2 extends PopupWindow {
    ...
    public RewardADPopupWindow2(Context context , View viewcontentView , int dpX , int dpY){
...
//        mViewBinding = DataBindingUtil.inflate(((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)), R.layout.view_rewardad_popup, null, false);
        ...
        x = Utils.getScreenWidth(context) - Utils.dip2px(context, 88) - Utils.dip2px(context, dpX);
    ...
    public void show(View anchor) {
        //显示范围
        setWidth(Utils.dip2px(context, 88));
