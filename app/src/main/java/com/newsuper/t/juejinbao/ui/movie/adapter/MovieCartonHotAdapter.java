...
public class MovieCartonHotAdapter extends RecyclerView.Adapter<MovieCartonHotAdapter.MyViewHolder>{
    private Context context;
    private List<MovieCartonHotEntity.DataBeanX.DataBean> items = new ArrayList<>();


    public MovieCartonHotAdapter(Context context){
        this.context = context;
    }


    public void update(List<MovieCartonHotEntity.DataBeanX.DataBean> items){
        this.items = items;
    ...
    class ItemView extends MyViewHolder implements View.OnClickListener {
        private MovieCartonHotEntity.DataBeanX.DataBean dataBean;
        ...
        public ItemView(ViewGroup parent) {
            super((ViewGroup) LayoutInflater.from(context).inflate(R.layout.item_movie_cartonhot, parent, false));
        ...
        public void setData(Object object , int position) {
            ...
            dataBean = (MovieCartonHotEntity.DataBeanX.DataBean) object;
