...
public class NumberProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int[] colorBg = {Color.parseColor("#ededed"), Color.parseColor("#ff9900")};
        if (mIfDrawText) {
            calculateDrawRectF();
        } else {
        ...
        if (mDrawReachedBar) {
            ...
            SweepGradient sweepGradient = new SweepGradient(canvas.getHeight(), canvas.getWidth() / 2, colorBg, null);
            mReachedBarPaint.setShader(sweepGradient);
