...
public class BigGoodsGroupAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    //分组显示商品
    ...
    public BigGoodsGroupAdapter(Context mContext, ArrayList<GoodsType> data, ShopCart shopCart, ShopInfoBean.ShopInfo shopInfo) {
