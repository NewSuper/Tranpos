...
public class GoodsSmallPicAdapter extends CustomAdapter {
    ...
    public GoodsSmallPicAdapter(Context mContext, ArrayList<GoodsListBean.GoodsInfo> data, WShopCart2 wShopCart, String flag) {
    ...
    public View getView(final int position) {
        ...
        final View convertView = LayoutInflater.from(mContext).inflate(R.layout.item_goods_small_pic, null);
