...
import com.newsuper.t.consumer.widget.RoundImageView;
...
public class PorterAdapter2 extends BaseAdapter {
    private Context context;
    private ArrayList<String> list;
    private boolean radioVal;
    private int height;
    public PorterAdapter2(Context context, ArrayList<String> list,int height,boolean radioVal) {
...
//        UIUtils.glideAppLoadCorner(context,url,R.mipmap.store_logo_default,holder.ivAd,radioVal);
    ...
    class PorterViewHolder {
        ...
        PorterViewHolder(View view) {
            ...
            LogUtil.log("PorterAdapter2","height == "+height);
