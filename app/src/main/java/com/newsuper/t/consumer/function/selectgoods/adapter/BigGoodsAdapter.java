...
public class BigGoodsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BigGoodsAdapter(Context mContext, ArrayList<GoodsListBean.GoodsInfo> data, ShopCart shopCart, ShopInfoBean.ShopInfo shopInfo) {
