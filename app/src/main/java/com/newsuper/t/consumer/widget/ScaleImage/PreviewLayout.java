package com.newsuper.t.consumer.widget.ScaleImage;
    ...
    public void setData(List<ThumbViewInfo> list, int index) {
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                Glide.with(getContext()).load(RetrofitManager.BASE_IMG_URL+mThumbViewInfoList.get(mIndex).getUrl()).into(mScalableImageView);
            }
        });
    }
