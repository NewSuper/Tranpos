...
public class GoodsThreeColumnsAdapter extends CustomAdapter {
    ...
    private String flag;
    private CustomThreeColumnsView parent;

    public GoodsThreeColumnsAdapter(Context mContext, ArrayList<GoodsListBean.GoodsInfo> data, WShopCart2 wShopCart, String flag) {
    ...
    public void setParentLayout(CustomThreeColumnsView parent){
        this.parent=parent;
    }
    @Override
    public int getCount() {
    ...
    public View getView(final int position) {
        ...
        final View convertView = LayoutInflater.from(mContext).inflate(R.layout.item_goods_three_columns, null);
        ...
        LinearLayout.LayoutParams p = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, (UIUtils.getWindowWidth()-60)/3);
        rl_img.setLayoutParams(p);
    ...
    public void notifyItemView(int pos) {
        View view=null;
        LinearLayout leftLinearLayout=(LinearLayout)parent.getChildAt(0).findViewById(R.id.leftLinearLayout);
        LinearLayout middleLinearLayout=(LinearLayout)parent.getChildAt(0).findViewById(R.id.middleLinearLayout);
        LinearLayout rightLinearLayout=(LinearLayout)parent.getChildAt(0).findViewById(R.id.rightLinearLayout);
        if(pos%3==0){
            view=leftLinearLayout.getChildAt(pos/3);
        }else if(pos%3==1){
            view=middleLinearLayout.getChildAt((pos-1)/3);
        }else{
            view=rightLinearLayout.getChildAt((pos-2)/3);
        }
        if(null!=view){
