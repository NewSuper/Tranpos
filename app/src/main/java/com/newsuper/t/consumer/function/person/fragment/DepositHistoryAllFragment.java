 ...
 */
public class DepositHistoryAllFragment extends Fragment implements IDepositHistoryView {
    ...
    private void loadData() {
        isLoading = true;
        HashMap<String, String> map = DepositHistoryRequest.depositHistoryRequest(token, adminId, page + "", "30", "0");
