...
public class WGoodsSmallPicAdapter2 extends BaseAdapter {
    ...
    public WGoodsSmallPicAdapter2(Context mContext, ArrayList<GoodsListBean.GoodsInfo> data, WShopCart2 wShopCart,String flag) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_goods_small_pic, null);
