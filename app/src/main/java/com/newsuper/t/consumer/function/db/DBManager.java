package com.newsuper.t.consumer.function.db;
...
public class DBManager {
    ...
    public void copyDBFile(){
        ...
        if (!dir.exists()){
            ...
            LogUtil.log("DBManager","copyDBFile");
        }
        File dbFile = new File(DB_PATH + DB_NAME);
        LogUtil.log("DBManager","uri==" +dbFile.getPath());
        if (!dbFile.exists()){
            Log.i("DBManager","dbFile");
            InputStream is;
            OutputStream os;
            try {
            ...
            LogUtil.log("DBManager","dbFile has == "+ dbFile.getPath());
        }
    }
