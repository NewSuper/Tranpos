...
public class Alipay {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (alipayPayListener != null){
                        alipayPayListener.onPaySuccess(resultStatus,"支付完成");
                    }
     ...
     * @param authInfo
     */
    private void auth(final String authInfo){
    ...
    public interface AlipayPayListener{
        void onPaySuccess(String statusCode, String msg);
