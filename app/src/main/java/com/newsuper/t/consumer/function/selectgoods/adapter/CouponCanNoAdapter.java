...
public class CouponCanNoAdapter extends BaseAdapter {
    private Context mContext;
    private ArrayList<ShoppingCartBean.DataBean.CouponListBean>  mCouponLists;

    public CouponCanNoAdapter(Context mContext, ArrayList<ShoppingCartBean.DataBean.CouponListBean>  mCouponLists) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ViewHolder holder1 = null;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_coupon_can_no, null);
