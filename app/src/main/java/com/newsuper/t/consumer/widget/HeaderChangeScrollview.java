...
public class HeaderChangeScrollview extends ScrollView {

    public HeaderChangeScrollview(Context context) {
        super(context);
    }

    public HeaderChangeScrollview(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public HeaderChangeScrollview(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void initView() {
        mHeader = (ViewGroup) findViewById(R.id.ll_goods);
        mHeaderChild = mHeader.getChildAt(0);
        mContent = findViewById(R.id.ll_goods);
