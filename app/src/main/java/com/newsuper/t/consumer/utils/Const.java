...
//    public static final String ADMIN_APP_ID = BuildConfig.ADMIN_APP_ID;//test app   测试
    ...
    public static final String ADMIN_ID = "91335";//开发
    public static final String QQ_APP_ID = "1106831085";
    public static final String WEIXIN_APP_ID = "wxa50560b1a8c2910f";
    public static final String ADMIN_APP_ID = "3733DSOZCV1525510432";//test app   测试
