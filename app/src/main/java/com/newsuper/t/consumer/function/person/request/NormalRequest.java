...
public class NormalRequest {
    public static HashMap<String,String>normalRequest(String lwm_sess_token,String admin_id){
    ...
    public static HashMap<String,String>normalRequest(String lwm_sess_token){
        ArrayList<String>param = new ArrayList<>();
        try {
            param.add("lwm_sess_token=" + URLEncoder.encode( lwm_sess_token,"UTF-8"));
        } catch (UnsupportedEncodingException e) {
