...
public class AnimatorView extends AppCompatTextView implements ValueAnimator.AnimatorUpdateListener {

    public static final int VIEW_SIZE = 16;
    ...
    public AnimatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint4Circle.setColor(getResources().getColor(R.color.theme_red));
    ...
    public void startBeizerAnimation() {
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                viewGroup.removeView(AnimatorView.this);
            }
        });
