...
import com.newsuper.t.consumer.function.person.adapter.DepositHistoryAdapter;
import com.newsuper.t.consumer.function.person.internal.IDepositHistoryView;
import com.newsuper.t.consumer.function.person.presenter.DepositHistoryPresenter;
import com.newsuper.t.consumer.function.person.request.DepositHistoryRequest;
 ...
 */
public class DepositHistoryPayFragment extends Fragment implements IDepositHistoryView {
    ...
    private void loadData() {
        isLoading = true;
        HashMap<String, String> map = DepositHistoryRequest.depositHistoryRequest(token, adminId, page + "", null, "1");
