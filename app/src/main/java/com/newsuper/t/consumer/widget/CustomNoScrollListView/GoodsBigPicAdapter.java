...
public class GoodsBigPicAdapter extends CustomAdapter {
    ...
    public GoodsBigPicAdapter(Context mContext, ArrayList<GoodsListBean.GoodsInfo> data, WShopCart2 wShopCart, String flag) {
    ...
    public View getView(final int position) {
        ...
        final View convertView = LayoutInflater.from(mContext).inflate(R.layout.item_goods_big_pic, null);
        ...
        rl_select_nature.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean isEffectiveVip = SharedPreferencesUtil.getIsEffectVip();
                boolean isShopMember = SharedPreferencesUtil.getIsShopMember();
                boolean isFreezenMember = SharedPreferencesUtil.getIsFreezenMember();

                LogUtil.log("iWShopCart"," setOnClickListener isEffectiveVip === "+isEffectiveVip);
                LogUtil.log("iWShopCart"," setOnClickListener isShopMember === "+isShopMember);
                LogUtil.log("iWShopCart"," setOnClickListener isFreezenMember === "+isFreezenMember);
                LogUtil.log("iWShopCart"," setOnClickListener memberlimit === "+goods.memberlimit);
                //会员专享商品判断
    ...
    public void notifyItemView(int pos) {
        ...
        if(null!=view){
            ...
            if (null != goods.nature && goods.nature.size() > 0 && goods.is_nature.equals("1")) {
                ...
                LogUtil.log("iWShopCart"," tvShowCount  =222== "+tvShowCount.getText().toString() );
            } else {
                if (count < 1) {
                    llMinus.setVisibility(View.GONE);
                    tvCount.setVisibility(View.GONE);
