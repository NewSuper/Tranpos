...
public class ShopCartDialog extends Dialog implements View.OnClickListener, IShopCart {
    ...
    public ShopCartDialog(Context context, ShopCart shopCart, String shop_id,int themeResId,boolean isEffectiveVip) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartAdapter=new CartDetailAdapter(getContext(),shopCart,isEffectiveVip,shop_id);
