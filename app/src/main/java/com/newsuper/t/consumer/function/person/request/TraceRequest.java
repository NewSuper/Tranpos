...
public class TraceRequest {
    ...
    public static HashMap<String, String> loadTraceData(String lwm_sess_token, String admin_id, String page, String pagesize) {
    ...
    public static HashMap<String, String> deleteTrace(String lwm_sess_token, String admin_id, String ids, String is_all) {
        ArrayList<String> param = new ArrayList<>();
        try {
            param.add("lwm_sess_token=" + URLEncoder.encode(lwm_sess_token, "UTF-8"));
            param.add("admin_id=" + URLEncoder.encode(admin_id, "UTF-8"));
            if (!StringUtils.isEmpty(ids))
                param.add("ids=" + URLEncoder.encode(ids, "UTF-8"));
            if (!StringUtils.isEmpty(is_all))
                param.add("is_all=" + URLEncoder.encode(is_all, "UTF-8"));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        String lwm_appid = RetrofitUtil.APP_ID;
