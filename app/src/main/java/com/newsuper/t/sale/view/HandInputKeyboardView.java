...
public class HandInputKeyboardView extends FrameLayout {
    ...
    public HandInputKeyboardView(@NonNull Context context) {
        this(context,null);
    }

    public HandInputKeyboardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public HandInputKeyboardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context);
    }

    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.handinput_keyboard_view_layout,this,true);
        ButterKnife.bind(this,view);
        btn_key_del.setBackground(new CustomGradient(GradientDrawable.Orientation.LEFT_RIGHT,
