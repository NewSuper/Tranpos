...
import com.newsuper.t.sale.adapter.ScanCodeQueryAdapter;
...
import com.newsuper.t.sale.ui.navi.FaceLoginActivity;
import com.newsuper.t.sale.ui.scan.manger.OrderItemManger;
import com.newsuper.t.sale.ui.scan.manger.OrderManger;
import com.newsuper.t.sale.ui.scan.mvp.PromptScanContract;
import com.newsuper.t.sale.ui.scan.mvp.PromptScanPresenter;
...
import com.newsuper.t.sale.view.SpacesItemDecoration;
import com.newsuper.t.sale.view.dialog.HandInputDialog;
import com.newsuper.t.sale.view.dialog.SpecsSelectDialog;
...
//        mGroup.setVisibility(View.GONE);
    ...
    protected void initData() {
        ...
        if(!TextUtils.isEmpty(member_str)){
            ...
            tv_member_name.setText(com.newsuper.t.sale.utils.StringUtils.Companion.getLast2str(mMember.getName()));
        }
    }
        ...
        switch (view.getId()){
            ...
            case R.id.btn_pay:
                ...
                AccountsBean accountsBean = new AccountsBean()
                        ...
                        .setReduction(vipPriceArr == null ? "0" : com.newsuper.t.sale.utils.StringUtils.Companion.formatPrice(vipPriceArr[1]));
    ...
    private void updateTotal(MultipleQueryProduct product, OrderItemManger.AddItemState state, int position){
        ...
        String totalPrice = com.newsuper.t.sale.utils.StringUtils.Companion.formatPrice(vipPriceArr[0]);
