...
import com.newsuper.t.markert.callback.INotifyRejectedListener
...
class RejectedGoodsAdapter(private val listener : INotifyRejectedListener) : BaseQuickAdapter<OrderItem,BaseViewHolder>(
    R.layout.item_rejected_goods_list_layout) {
