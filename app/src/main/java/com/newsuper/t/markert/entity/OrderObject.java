...
//    public GlobalEnums.CashierAction cashierAction;
    ...
    public double getAmount() {
        return StringKotlin.Companion.formatPriceDouble((float) amount);
    }
    ...
    public double getDiscountAmount() {
        return StringKotlin.Companion.formatPriceDouble((float) discountAmount);
    }
    ...
    public double getReceivableAmount() {
        return StringKotlin.Companion.formatPriceDouble((float) receivableAmount);
    }
    ...
    public double getReceivedAmount() {
        return StringKotlin.Companion.formatPriceDouble((float) receivedAmount);
    }
