...
public class TwelveKeyboardView extends FrameLayout {
    ...
    public TwelveKeyboardView(@NonNull Context context) {
        this(context,null);
    }

    public TwelveKeyboardView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public TwelveKeyboardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context);
    }

    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.twelve_keyboard,this,true);
