...
public class TscCommand {
    ...
    public void addBitmap(int x, int y, BITMAP_MODE mode, int nWidth, Bitmap b) {
        if(b != null) {
            ...
            this.addStrToCommand(str);
            byte[] codecontent = GpUtils.pixToTscCmd(src);

            for (byte aCodecontent : codecontent) {
                this.Command.add(Byte.valueOf(aCodecontent));
            }
    ...
    public static enum FONTTYPE {
        ...
        FONT_7("7"),
        FONT_8("8"),
        SIMPLIFIED_CHINESE("TSS24.BF2"),//简化中文
        TRADITIONAL_CHINESE("TST24.BF2"),//传统中文
        KOREAN("K");//韩文
